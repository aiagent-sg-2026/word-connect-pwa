...
for (const level of CAMPAIGN.levels) {
  ...
  if (recomputed !== level.hash) throw new Error(`campaign-en-v1 level hash mismatch ${level.levelId}`);
...
console.log(JSON.stringify({ ok: true, dictionaryChecksum: dict.manifest.checksum, labCampaignHash, campaignEnV1Hash: currentHash }));
